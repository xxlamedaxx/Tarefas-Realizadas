...
CORRETA: A, booleana imprime true, e o código calcula o produto e imprime.
...
CORRETA: A, while para no indice 3 ai imprime 400
...
CORRETA: B, utiliza os comandos de if, eles para se for algo faça x, se nao faça y e assim que funciona a logica.
...
Classe Carro herda de Veiculo:
    ...
    Método Construtor(modelo, ano, eficiencia):
        ...
        this.eficienciaKmPorLitro <- eficiencia
    Método CalcularConsumo(distancia):
        Retornar distancia / eficienciaKmPorLitro
...
Senão
    Escreva("Não foi possível atingir a velocidade segura dentro do tempo limite.")
```
______
